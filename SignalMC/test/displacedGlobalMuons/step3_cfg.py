...
# with command line options: step2 --filein file:step2b.root --fileout file:step3.root --mc --eventcontent RECOSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring,DisappTrks/SignalMC/genParticlePlusGeant.customizeKeep,DisappTrks/SignalMC/genParticlePlusGeant.customizeProduce --datatier RECOSIM --conditions MCRUN2_74_V9 --step RAW2DIGI,L1Reco,RECO --magField 38T_PostLS1 --python_filename step3_cfg.py --no_exec -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:step2b/step2b_250gev_100cm.root'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step3/step3_250gev_100cm.root'),
