...
# with command line options: step1 --filein file:step1.root --fileout file:step2a.root --pileup_input dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIIWinter15GS-MCRUN2_71_V1-v1/GEN-SIM --mc --eventcontent RAWSIM --pileup 2015_25ns_Startup_PoissonOOTPU --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring,DisappTrks/SignalMC/genParticlePlusGeant.customizeKeep,DisappTrks/SignalMC/genParticlePlusGeant.customizeProduce --datatier GEN-SIM-RAW --conditions MCRUN2_74_V9 --step DIGI,L1,DIGI2RAW # ,HLT:@frozen25ns --magField 38T_PostLS1 --python_filename step2a_cfg.py --no_exec -n 100
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step1/step1_250gev_100cm.root'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step2a/step2a_250gev_100cm.root'),
