...
cosmicMuonHistograms = cms.PSet(
    ...
    histograms = cms.VPSet (
        ...
        cms.PSet (
            name = cms.string("muonNumberOfValidMuonHitsOuterTrack"),
            title = cms.string("Muon Number of Valid Muon Hits from Outer Track;muon numberOfValidMuonHits"),
            binsX = cms.untracked.vdouble(30, 0, 30),
            inputVariables = cms.vstring("muon.outerTrack.hitPattern_.numberOfValidMuonHits"),
        ),
        cms.PSet (
            name = cms.string("nLostMuonHitsOuterTrack"),
            title = cms.string("Muon Number of Lost Muon Hits from Outer Track;nLost"),
            binsX = cms.untracked.vdouble(30, 0, 30),
