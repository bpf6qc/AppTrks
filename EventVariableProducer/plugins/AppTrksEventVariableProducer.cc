...
#include "AppTrks/EventVariableProducer/plugins/AppTrksEventVariableProducer.h"

AppTrksEventVariableProducer::AppTrksEventVariableProducer(const edm::ParameterSet &cfg) :
...
AppTrksEventVariableProducer::~AppTrksEventVariableProducer() {}

void
AppTrksEventVariableProducer::AddVariables (const edm::Event &event) {
...
bool
AppTrksEventVariableProducer::passCleaning(double eta, double phi, OriginalCollections &handles)
{
  bool muonClean = true;
  bool eleClean = true;
...
void
AppTrksEventVariableProducer::getOriginalCollections (const unordered_set<string> &objectsToGet, const edm::ParameterSet &collections, OriginalCollections &handles, const edm::Event &event)
{
...
DEFINE_FWK_MODULE(AppTrksEventVariableProducer);
